...
$(call inherit-product-if-exists, vendor/samsung/goldenvewifi/goldenvewifi-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/samsung/goldenvewifi/overlay
...
PRODUCT_NAME := full_goldenvewifi
PRODUCT_DEVICE := goldenvewifi
